...
function drawGrid( colCount = 3, rowCount = 3, cellWidth = 6, cellHeight = 3, vSep = "┃", hSep = "━", xSep = "╋" ) {
...
function toppingChecker(topping) {
    switch (topping) {
        case "pepperoni":
        case "ham":
        case "pineapple":
...
function passLengthChecker(password) {
...
function schedulePrinter(time, placeOfWork, townOfHome) {
...
console.log( lastVowel("ajkrngjksdjvklsdjkvsdurhgjusdrhgsdhrguhdyugdryuvhjdhdujhvsrhgsudghukldgudhrjdnkigjsdrkgjsdkirjg") );function firstLast(str) {
